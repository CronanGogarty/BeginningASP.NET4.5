<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ValidationForm.aspx.cs" Inherits="BeginningASP.NET4._5.ValidationControls.ValidationForm" %>
        ...
        <div>
            <div class="divInput">
                ...
                <asp:RequiredFieldValidator 
                    ...
                    ErrorMessage="User Name cannot be blank"></asp:RequiredFieldValidator></div>
            <div class="divInput">
            ...
            <div class="divInput">
                ...
                <asp:RequiredFieldValidator 
                    ...
                    ControlToValidate="txtRepeatPassword" 
                    ErrorMessage="Re-type your password"></asp:RequiredFieldValidator></div>
            <div class="divInput">
                ...
                <asp:RegularExpressionValidator 
                    ...
                    ErrorMessage="Please enter a valid email address"></asp:RegularExpressionValidator></div>
            <div class="divInput">
                ...
                <asp:RangeValidator 
                    ...
                    MinimumValue="18" 
                    MaximumValue="99" 
                    ErrorMessage="Age must be between 18 - 99"></asp:RangeValidator></div>
            <div class="divInput">
                ...
                <asp:CustomValidator 
                    ...
                    OnServerValidate="vldReferrerCustomValidator_ServerValidate"></asp:CustomValidator></div>
            <div class="divInput">
                <asp:Button runat="server" ID="cmdSubmit" Text="Submit" OnClick="cmdSubmit_Click" />&nbsp;<asp:Button runat="server" ID="cmdCancel" CausesValidation="false" Text="Cancel" OnClick="cmdCancel_Click" /></div>
